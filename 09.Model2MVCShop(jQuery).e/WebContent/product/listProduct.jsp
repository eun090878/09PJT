 ...
 */
 		...
 		$(function() {
	 		...
	 		$(".ct_list_pop td:nth-child(3) span").on("click", function() {
	 			alert($(this).attr('noval')+" :: dsf :: " + $(this).attr('mval'));
	 			self.location = " /product/getProduct?prodNo="+$(this).attr('noval')+"&menu="+$(this).attr('mval');		
	 			
	 		});
 		
	 		$(".ct_list_pop td:nth-child(9) span").on("click", function() {
	 			alert($(this).attr('noval')+" :: dsf :: " + $(this).attr('codeval'));
	 			self.location = "/purchase/updateTranCodeByProd?prodNo="+$(this).attr('noval')+"&tranCode="+$(this).attr('codeval');		
